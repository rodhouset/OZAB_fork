...
namespace model_OZAB_model_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_OZAB_model");
    reader.add_event(67, 65, "end", "model_OZAB_model");
    return reader;
}
...
class model_OZAB_model
  : public stan::model::model_base_crtp<model_OZAB_model> {
private:
        int N;
        int K;
        vector_d c;
        ...
        matrix_d Xp;
public:
    model_OZAB_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_OZAB_model_namespace::model_OZAB_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_OZAB_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_OZAB_model_namespace::model_OZAB_model stan_model;
#ifndef USING_R
