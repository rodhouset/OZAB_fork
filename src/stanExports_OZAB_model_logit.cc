...
#include "stanExports_OZAB_model_logit.h"

RCPP_MODULE(stan_fit4OZAB_model_logit_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_OZAB_model_logit")
